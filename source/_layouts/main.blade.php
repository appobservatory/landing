...
<body class="text-gray-900 font-sans antialiased min-h-full">
  ...
  <footer class="mt-24 bg-gray-900 sm:mt-12">
    <div class="mx-auto max-w-md py-12 px-4 overflow-hidden sm:max-w-3xl sm:px-6 lg:max-w-7xl lg:px-8">
      ...
      <p class="mb-8 text-center text-base text-gray-400">&copy; {{ date('Y') }} <a href="/">App Observatory</a>. All
        rights
        reserved.</p>

      <nav class="-mx-5 -my-2 flex flex-wrap justify-center" aria-label="Footer">
        <div class="px-5 py-2">
          <a href="/terms" class="text-base text-gray-400 hover:text-gray-300"> Terms </a>
        </div>

        <div class="px-5 py-2">
          <a href="/privacy" class="text-base text-gray-400 hover:text-gray-300"> Privacy </a>
        </div>
      </nav>
    </div>
  </footer>
